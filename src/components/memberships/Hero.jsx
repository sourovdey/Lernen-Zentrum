...
import hero from "../../assets/community_image.png";
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <p className="text-gray-600 max-w-lg">
              Get access to a structured Discord space where you can practice speaking, connect with learners, and improve daily.
            </p>
          ...
          <div className="flex-1 w-full">
            ...
            <img
              src={hero}
              alt="Hero Image"
              className="w-full sm:w-full md:w-full lg:w-full xl:w-full max-w-none mx-auto object-cover"
            />
